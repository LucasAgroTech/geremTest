...
class SharePointClient:
    ...
    def download_file(self, file_path):
        ...
        try:
            ...
            # Tentar primeiro com o caminho que está funcionando baseado nos logs
            file_url = f'/sites/{self.site_name}/Documentos Compartilhados/{folder_path}/{file_name}'
            ...
            try:
                ...
                # Tentar construir diferentes URLs possíveis, priorizando os que funcionaram nos logs
                possible_urls = [
                    ...
                    f'/sites/{self.site_name}/{self.doc_library}/{folder_path}/{file_name}',
    ...
    def upload_file(self, file_content, file_path):
        ...
        try:
            ...
            # Usar primeiro o caminho que está funcionando baseado nos logs
            target_folder_url = f'/sites/{self.site_name}/Documentos Compartilhados'
            if folder_path:
            ...
            try:
                ...
                # Tentar com diferentes caminhos de pasta, priorizando os que funcionaram nos logs
                possible_urls = [
